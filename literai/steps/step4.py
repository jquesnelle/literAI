...
@free_memory_after
def step4(title: str, draw_model: str, draw_prompt: str, single_part: Optional[str]):
...
def main():
    ...
    step4(args.title, args.draw_model, args.draw_prompt, single_part=args.single_part)
